	...
	<div class="col2-set row row-divided row-large" id="customer_login">
		...
		<div class="col-1 large-6 col pb-0">
			...
			<div class="account-login-inner">
				...
				<h3 class="woocommerce-form-title"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h3>
				...
				<form class="woocommerce-form woocommerce-form-login login" method="post">
                    ...
                    <p class="woocommerce-LostPassword lost_password">
                        <a class="mint" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Forgot your password??', 'woocommerce' ); ?></a>
                    </p>
		...
		<div class="col-2 large-6 col pb-0">
			...
			<div class="account-register-inner">
				...
				<h3 class="woocommerce-form-title"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h3>
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<?php else : ?>
						...
						<p class="woocommerce-password-text"><?php esc_html_e( 'A password will be sent to your email address.', 'woocommerce' ); ?></p>

					<?php endif; ?>

                    <p class="woocommerce-form-row form-row">
                        <?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
                        <button type="submit" class="btn btn-outline woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Register an account', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
                    </p>
